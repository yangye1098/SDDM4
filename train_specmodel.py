...
def main(config):
    ...
    # setup dataset
    tr_dataset = config.init_obj('tr_dataset', module_data, n_spec_frames=n_spec_frames, spec_config=spec_config,
                                 sample_rate=config['sample_rate'])
    val_dataset = config.init_obj('val_dataset', module_data, n_spec_frames=n_spec_frames, spec_config=spec_config,
                                  sample_rate=config['sample_rate'])
    if world_size > 1:
    ...
    tr_data_loader = config.init_obj('data_loader', module_data, dataset=tr_dataset, sampler=tr_sampler)
    val_data_loader = config.init_obj('data_loader', module_data, dataset=val_dataset)
